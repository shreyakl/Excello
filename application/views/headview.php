...
<head>
    ...
    <meta name="description" content="DILAWZ KK">
    <meta name="keywords" content="EXCELLO, Mec">
    <!-- bootstrap 3.0.2 -->
    ...
    <link href="<?php echo base_url('assets/css/regstyle.css') ?>" rel="stylesheet"> 
                        ...
                        <section class="sidebar">
                            ...
                            <ul class="sidebar-menu">
                                <li class="active">
                                    <a href="
                                    index.html">
                                        <i class="fa fa-dashboard"></i> <span>Company Lists</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="general.html">
                                        <i class="fa fa-gavel"></i> <span>Add New</span>
                                    </a>
                                </li>

                                <li>
                                    <a href="basic_form.html">
                                        <i class="fa fa-globe"></i> <span>Finalised</span>
                                    </a>
                                </li>
                            </ul>
                        </section>
                                        ...
                                        <div id="myregistration" class="modal fade in" role="dialog">
                                            ...
                                            <div class="modal-content row">
                                                ...
                                                <div class="modal-body">
                                                    <form name="info_form" class="form-inline" action="<?php echo base_url();?>index.php/welcome/registration" method="post">
